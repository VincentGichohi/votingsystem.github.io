...
class PrintView(PDFView):
    template_name = 'administrator/admin/print.html'
...
def dashboard(request):
    ...
    return render(request, "administrator/admin/home.html", context)
...
def viewVotes(request):
    ...
    return render(request, "administrator/admin/votes.html", context)
